...
function Rs20() {
  ...
  return (
    <div className="container mt-5">
      ...
      <h2 className="text-center text-primary fw-bold">Join ₹20 Contest</h2>
      ...
      <div>
        <ul className="list-group list-group-flush text-center">
          ...
          <li className="list-group-item">1️⃣ 1st Winner Gets ₹400 ✅</li>
          <li className="list-group-item">2️⃣ 2nd Winner Gets ₹200 ✅</li>
          <li className="list-group-item">3️⃣ 3rd Winner Gets ₹100 ✅</li>
          <li className="list-group-item">4️⃣ 4th Winner Gets ₹50 ✅</li>
          <li className="list-group-item">5️⃣ 5th Winner Gets ₹50 ✅</li>
        </ul>
      </div>
      ...
      <div className="text-center mt-4">
        ...
        <p>Scan the QR code <br /> Any UPI APP to pay ₹20</p>
      </div>
